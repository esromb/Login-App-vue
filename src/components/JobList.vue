...
<script>
import EventCard from '@/components/JobCard';
export default {
  name: 'EventsList',
  components : {
    EventCard
      ...
      events: [
        {
          ...
          description: 'Create a new skill per requirement of the project',
          },
        {
          id: 2,
          name: 'Create Role',
          category: 'Roles',
          description: 'Add a new role per requirement to the project',
        },
          {
          id: 3,
